...
\begin{document}
	...
	**Downsides of MCDO and ADF to be read and listed**\pagebreak
	...
	\subsection{Evidential distribution}
	...
	\end{equation} 
	\subsubsection{Significance of NIG parameters}
	...
	\end{equation}
	\pagebreak
	\subsubsection{The distribution hierarchy}
	\begin{figure}[h]
		\centering
	...
	\end{itemize}
	\subsection{Evidential learning objectives}
