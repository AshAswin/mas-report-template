...
\begin{subfigure}[b]{0.45\textwidth}
	\centering
	\includegraphics[scale=0.20]{nll/near_small.pdf}
...
\begin{subfigure}[b]{0.45\textwidth}
	\centering
	\includegraphics[scale=0.20]{nll/far_large.pdf}
...
\begin{subfigure}[b]{0.45\textwidth}
	\centering
	\includegraphics[scale=0.20]{nll/far_small.pdf}
...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[scale=0.19]{toy_dataset_pdf/homo_fn1.pdf}
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[scale=0.19]{toy_dataset_pdf/hetero_fn1.pdf}
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[scale=0.19]{toy_dataset_pdf/mcdo_fn1.pdf}
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[scale=0.19]{toy_dataset_pdf/der_fn1.pdf}
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[scale=0.19]{toy_dataset_pdf/homo_fn2.pdf}
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[scale=0.19]{toy_dataset_pdf/hetero_fn2.pdf}
...
\begin{figure}[H]\ContinuedFloat
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[scale=0.19]{toy_dataset_pdf/mcdo_fn2.pdf}
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[scale=0.19]{toy_dataset_pdf/der_fn2.pdf}
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[scale=0.19]{toy_dataset_pdf/homo_fn3.pdf}
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[scale=0.19]{toy_dataset_pdf/hetero_fn3.pdf}
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[scale=0.19]{toy_dataset_pdf/mcdo_fn3.pdf}
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[scale=0.19]{toy_dataset_pdf/der_fn3.pdf}
...
\subsection {Response to OOD Data}\label{subsec_ood}
...
Except for the case of images with different levels of fog where MCDO\_ADF shows a desirable response, any significant relationship between the considered set of variables could not be established, in the other two cases. Observations such as unchanging values of uncertainty estimated by DER for increasing levels of fog and snow, and existence of alignment between uncertainty estimates and predictive error of the DER model variant in the case of dark images, show that factors such as model calibration and invariance of a model to a feature have a role to play. In order to better understand responses of the chosen pair of uncertainty estimation methods to OOD inputs, the analysis is extended to the test split of the steering angle dataset.
 \begin{figure}[H]
	\centering
	\includegraphics[width=0.3\textwidth]{noise/original}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{ood/noise_plots}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{adversarial/adv_plots}
...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|c|} 
		...
		\hline
		\multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}Response to OOD inputs\\(1D datasets) \end{tabular}} & NLL                                                                                                                        & DER                         \\ 
		\cline{2-3}
		& RMSE                                                                                                                       & MCDO\_ADF                   \\
		\hline
	\end{tabular}
