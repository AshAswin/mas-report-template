...
\begin{figure}[h]
	...
	\caption{Sample images from the Udacity steering angle dataset. Image source: Udacity steering angle dataset}
...
\begin{figure}
	\includegraphics[scale=0.32]{resnet8_new}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.7]{1d_neural_net}
